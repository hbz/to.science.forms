...
public class ResearchDataKtbl extends ZettelModel {
	/**
	 * The id under which this model is registered in the ZettelRegister
	 */
	public final static String id = "katalog:researchDataKtbl";

	public List<String> getType() {
		return Arrays.asList("http://hbz-nrw.de/regal#ResearchDataKtbl");
	}
	...
	public static String getHelpTextUrl() {
		String url = ConfigFactory.load().getString("zettel.researchDataKtbl.helpText");
		return url;
	}
